export default function LoginPage() {
    return (
      <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px] py-40 bg-[#1a1a1a]">
        ...
        <div className="space-y-2">
          ...
          />
          <button className="bg-black rounded-md text-white dark:bg-white dark:text-black rounded-md hover:bg-gray-300 dark:Hover:bg-gray-200 disabled:opacity-25 text-base px-4 py-2 w-full">Sign in with email</button>
        </div>
      </div>
    );
  }
